...
public class AlquilerSurf extends AppCompatActivity {
    ...
    CheckBox cbhora;
    TextView ttotal,thora,tdia;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Intent intent = this.getIntent();
        nombreescuela=intent.getStringExtra("nombre");
        setContentView(R.layout.activity_alquiler_surf);
        setTitle("Alquiler de surf");
        ...
        try {
            ...
            String shora=respuesta.getString("surfhora");
            String sdia=respuesta.getString("surfdia");
            if(shora.equals("0")||sdia.equals("0")){
                Toast.makeText(AlquilerSurf.this, "Esta escuela no ha definido aún los precios para el alquiler de surf",
        ...
        if(correcto) {
            ...
            thora = (TextView) findViewById(R.id.txHora);

            thoras = (EditText) findViewById(R.id.txHour);
            thoras.setEnabled(false);
            txfecha = (EditText) findViewById(R.id.txFecha);
            tdia = (TextView) findViewById(R.id.txDia);
            ttotal = (TextView) findViewById(R.id.txTotal);
            ttablas = (EditText) findViewById(R.id.txTablas);
            cbhora = (CheckBox) findViewById(R.id.cbHora);
            Button balquilar = (Button) findViewById(R.id.balquilar);
            try {
                System.out.println(respuesta.getString("surfhora") +" "+respuesta.getString("surfdia"));
                preciohora = Integer.parseInt(respuesta.getString("surfhora"));

                preciodia = Integer.parseInt(respuesta.getString("surfdia"));
            ...
            balquilar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (fecha.equals("") || factura.equals("") || cantidad == 0 || fecha.equals("DD/MM/AAAA")) {
                        new AlertDialog.Builder(AlquilerSurf.this)
                        ...
                        if (thoras.getText().toString().equals("") || thoras.getText().toString().equals("Hour (16:00)")) {
                            ...
                            if (correcto) {
                                ...
                                try {
                                    respuesta = cpl.newAlquiler(fecha, cantidad, factura, usuario, "tabla surf", hora, nombreescuela, "");
                                } catch (ExecutionException e) {
                                    e.printStackTrace();
                                } catch (InterruptedException e) {
                                    e.printStackTrace();
